...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light sticky-top opacity-75">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="assets/img/logo-text.png" width="97">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#Green">Green Initiative</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Video">Video Produk</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-9">
                    <div class="text-center text-white justify-content-center">
                        <!-- Page heading-->
                        <h4 class="text-black">KESEGARAN DALAM TIAP TEGUKAN</h4>
                        <hr class="border border-2 mx-auto rounded-4" width="30%">
                        <h1 class="fw-bold mb-5 text-black">Kualitas Air Murni Terbaik dari Alam dengan Kemasan
                            Berkelanjutan!</h1>
                        <button type="button" class="btn btn-primary rounded-4 d-flex align-items-center mx-auto ps-3"
                            style="--bs-btn-padding-y: .3rem; --bs-btn-padding-x: .5rem; --bs-btn-color: --bs-primarycolor !important;">
                            Discover More<iconify-icon icon="iconamoon:arrow-right-2-duotone" height="30"
                                preserveAspectRatio="xMidYMid slice"></iconify-icon>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <section class="call-to-action text-white text-center">
        <div class="container position-relative">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <h2 class="mb-4">Silahkan tekan tombol dibawah untuk memulai Pre-Test</h2>
                    <button type="button" onclick='location.href= "\pre-test"'
                        class="btn btn-primary rounded-4 d-flex align-items-center mx-auto"
                        style="--bs-btn-padding-y: .7rem; --bs-btn-color: --bs-primarycolor;">Mulai Pre-Test</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                    ...
                    <p class="text-muted small mb-4 mb-lg-0">&copy; PT Cista Water 2024. All Rights Reserved.</p>
                </div>
