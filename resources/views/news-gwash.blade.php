            ...
            <div class="col-lg-8">
                ...
                <article class="card border-0 shadow-sm rounded-4 p-4 p-md-5 mb-5 bg-white">
                    ...
                    <header class="mb-4">
                        ...
                        <!-- Post title-->
                        <h1 class="fw-bolder mb-3 text-dark" style="font-size: 2.25rem; line-height: 1.3;">Menelisik Kebenaran dalam Retorika Hijau Perusahaan Cista</h1>
                        <!-- Post meta content-->
                    ...
                    <figure class="mb-0">
                        <div class="ratio ratio-16x9 mx-auto rounded-4 overflow-hidden shadow-sm">
                            <iframe src="https://www.youtube.com/embed/e0yTPSj2R5o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                    </figure>
                </article>
            </div>
